 ...
 * @LastEditTime: 2024-04-05 13:33:51
 * @License: GPL 3.0
 */
...
int32_t Arduino_PCF8563::IIC_Read_Device_ID(void)
{
    uint8_t temp_buf = 0;
...
bool Arduino_PCF8563::IIC_Write_Device_State(uint32_t device, uint8_t state)
{
    ...
    case Arduino_IIC_RTC::Device::RTC_CLOCK_RTC:
        ...
        break;
    case Arduino_IIC_RTC::Device::RTC_CLOCK_OUTPUT:
        switch (state)
        {
        case Arduino_IIC_RTC::Device_State::RTC_DEVICE_ON:
...
bool Arduino_PCF8563::IIC_Write_Device_Value(uint32_t device, int64_t value)
{
    ...
    switch (device)
    {
    case Arduino_IIC_RTC::Device_Value::RTC_SET_SECONDS_DATA: // 0-59
        if (value >= 0 && value <= 59)
        {
        ...
        break;
    case Arduino_IIC_RTC::Device_Value::RTC_SET_MINUTES_DATA: // 0-59
        if (value >= 0 && value <= 59)
        {
        ...
        break;
    case Arduino_IIC_RTC::Device_Value::RTC_SET_HOURS_DATA: // 0-23
        if (value >= 0 && value <= 23)
        {
        ...
        break;
    case Arduino_IIC_RTC::Device_Value::RTC_SET_DAYS_DATA: // 1-31
        if (value >= 1 && value <= 31)
        {
        ...
        break;
    case Arduino_IIC_RTC::Device_Value::RTC_SET_MONTHS_DATA: // 1-12
        if (value >= 1 && value <= 12)
        {
        ...
        break;
    case Arduino_IIC_RTC::Device_Value::RTC_SET_YEARS_DATA: // 0-99
        if (value >= 0 && value <= 99)
        {
    ...
    case Arduino_IIC_RTC::Device_Value::RTC_TIMER_FLAG_TF: // 0
        ...
        break;
    case Arduino_IIC_RTC::Device_Value::RTC_SET_ALARM_MINUTES_DATA: // 0-59
        if (value >= 0 && value <= 59)
        {
            if (_bus->IIC_ReadC8D8(_device_address, PCF8563_RD_WR_MINUTE_ALARM, &temp_buf) == true)
            {
