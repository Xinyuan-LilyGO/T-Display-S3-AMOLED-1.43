 ...
 * @LastEditTime: 2024-03-28 14:21:18
 * @License: GPL 3.0
 */
#pragma once
...
class Arduino_IIC : public Arduino_IIC_Power, public Arduino_IIC_Touch, public Arduino_IIC_IMU, public Arduino_IIC_RTC
{
public:
    ...
    virtual int32_t IIC_Read_Device_ID(void) = 0;
